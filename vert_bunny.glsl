...
vec3 kd = vec3(.8, .8, 0);     // diffuse reflectance coefficient
vec3 ka = vec3(0.3, 0.3, 0);   // ambient reflectance coefficient
vec3 ks = vec3(0.8, 0.8, .8);   // specular reflectance coefficient
